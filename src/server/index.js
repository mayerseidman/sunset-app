...
var job = new CronJob('05 09 * * *', function() { 
...
var job = new CronJob('05 10 * * *', function() { 
	mongodb.MongoClient.connect(url, (err, client)=>{
		const  db = client.db('heroku_9v9cjldm') 
		var users = db.collection('users')
		sendSMS(users, CT)
...
var job = new CronJob('05 11 * * *', function() { 
	mongodb.MongoClient.connect(url, (err, client)=>{
		const  db = client.db('heroku_9v9cjldm') 
		var users = db.collection('users')
		sendSMS(users, MT)
...
var job = new CronJob('05 12 * * *', function() { 
	mongodb.MongoClient.connect(url, (err, client)=>{
		const  db = client.db('heroku_9v9cjldm') 
		var users = db.collection('users')
		sendSMS(users, PST)
...
// EUROPE
var job = new CronJob('05 03 * * *', function() { 
	mongodb.MongoClient.connect(url, (err, client)=>{
		const  db = client.db('heroku_9v9cjldm') 
		var users = db.collection('users')
		sendSMS(users, EURO)
...
// AUS
var job = new CronJob('05 19 * * *', function() { 
	mongodb.MongoClient.connect(url, (err, client)=>{
		const  db = client.db('heroku_9v9cjldm') 
		var users = db.collection('users')
		sendSMS(users, AUS)
...
// SEA
var job = new CronJob('05 21 * * *', function() { 
	mongodb.MongoClient.connect(url, (err, client)=>{
		const  db = client.db('heroku_9v9cjldm') 
		var users = db.collection('users')
		sendSMS(users, SEA)
